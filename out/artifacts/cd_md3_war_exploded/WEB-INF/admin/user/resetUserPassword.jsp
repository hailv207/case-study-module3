...
<div class="container-fluid">
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <input name="name" type="text" disabled class="form-control" id="name" aria-describedby="emailHelp"
                   placeholder="Nhập họ tên" value="${selectedUser.getName()}">
        </div>
        <div class="form-group">
            <label for="phone">Số điện thoại</label>
            <input type="text" name="phone" disabled class="form-control" id="phone" placeholder="0xxxxxxxxx"
                   value="${selectedUser.getPhone()}">
        </div>
        <div class="form-group">
            <label for="email">Email</label>
            <input type="email" name="email" disabled class="form-control" id="email" placeholder="example@somemail.com"
                   value="${selectedUser.getEmail()}">
        </div>
        <div class="form-group">
            <label for="address">Địa chỉ</label>
            <input name="address" type="text" disabled class="form-control" id="address" placeholder="Nhập địa chỉ"
                   value="${selectedUser.getAddress()}">
        </div>
        <p style="color: coral">Lưu ý: Sau khi đặt lại mật khẩu, mật khẩu sẽ được khôi phục về mặt định.</p>
        <button type="submit" class="btn btn-primary" formmethod="post">Đặt lại mật khẩu</button>
