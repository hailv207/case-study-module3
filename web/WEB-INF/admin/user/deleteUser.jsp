...
<div class="container-fluid">
    ...
    <form>
        ...
        <p style="color: coral">Lưu ý: Sau khi xoá người dùng khỏi hệ thống thì không thể hoàn tác.</p>
        <button type="submit" class="btn btn-primary" formmethod="post">Xoá người dùng</button>
