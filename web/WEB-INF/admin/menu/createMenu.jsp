...
<div class="container-fluid">
    ...
    <form action="/menu?action=create">
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="menuType" name="menuType">
                <c:forEach items='${requestScope["menuTypeList"]}' var="menuType">
                    <option value="${menuType.getId()}">${menuType.getName()}</option>
                </c:forEach>
        ...
        <button type="submit" class="btn btn-primary" formmethod="post">Tạo món</button>
