...
<div class="container-fluid">
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <select disabled class="form-control" id="menuType" name="menuType">
        ...
        <div class="form-group">
            ...
            <input name="name" disabled type="text" class="form-control" id="name"
                   placeholder="Nhập tên món" value="${selectedMenu.getName()}">
        </div>
        <div class="form-group">
            <label for="unit">Đơn vị</label>
            <input name="unit" disabled type="text" class="form-control" id="unit"
                   placeholder="Nhập đơn vị" value="${selectedMenu.getUnit()}">
        </div>
        <div class="form-group">
            <label for="price">Giá</label>
            <input name="price" disabled type="text" class="form-control" id="price"
                   placeholder="Nhập giá" value="${selectedMenu.getPrice()}">
        </div>
        <div class="form-group">
            <label for="imageURL">Link ảnh</label>
            <input name="imageURL" disabled type="text" class="form-control" id="imageURL"
                   placeholder="Nhập link ảnh" value="${selectedMenu.getImageURL()}">
        </div>
        <div class="form-group">
            <label for="name">Ngày tạo</label>
            <input disabled name="createDate" type="text" class="form-control" id="createDate"
                    value="${selectedMenu.getCreateDate()}">
        </div>
        <div class="form-group">
            <label for="status">Trạng thái</label>
            <select disabled class="form-control" id="status" name="status">
                <option <c:if test="${selectedMenu.getStatus() eq 'selling'}"> selected </c:if> value="selling">Đang bán</option>
                <option <c:if test="${selectedMenu.getStatus() eq 'stopped'}"> selected </c:if> value="stopped">Đã ngừng</option>
            </select>
        </div>
        <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary" formmethod="post">Xoá món</button>
